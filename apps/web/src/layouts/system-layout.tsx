...
const navByKind: Record<WorkspaceKind, NavItem[]> = {
  system: [
    ...
    { to: "/system/billing", label: "Billing", icon: FileSpreadsheet, permission: "reports.view_approved", badge: "billing", isActivePath: (p) => isBillingNavActive(p, "/system/billing") },
